...
var lessonsView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#lessons',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#lessons',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["previouslessonsbutton"] = new ClickControl({selector:'#lessons',childSelector:'.previous-container .previous-button',callback:function(e){
			settings.previousLessonButtonClicked.notify();
		}});
		_clickControls["selectionItem"] = new ClickControl({selector:'#lessons',childSelector:'.bar-item, .lesson-item, .previous-item',callback:function(e){
	...
	settings.start = function(){
		...
		_iosScrollView = new IScroll('#lessons .wrapper-scroller',{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
	};
...
var lessonsTasteListView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#lesson-how-to-taste-list',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#lesson-how-to-taste-list',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["selectionItem"] = new ClickControl({selector:'#lesson-how-to-taste-list',childSelector:'.list-item',callback:function(e){
	...
	settings.populateTemplate = function(templateData){
		...
		_iosScrollView = new IScroll('#lesson-how-to-taste-list .wrapper-scroller',{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
...
var lessonsTasteDescView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#lesson-how-to-taste-desc',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#lesson-how-to-taste-desc',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["iconSelected"] = new ClickControl({selector:'#lesson-how-to-taste-desc',childSelector:'.icon-item',callback:function(e){
	...
	settings.populateTemplate = function(templateData,sIndex){
		...
		if(!$.isEmptyObject(_iosScrollView)){
			for(var key in _iosScrollView){
				...
				_iosScrollView[key] = new IScroll('#'+key,{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
			};
		}else{
			$('#lesson-how-to-taste-desc .desc-item').each(function(){
				_iosScrollView["desc-item-"+$(this).index()] = new IScroll('#'+$(this).attr('id'),{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
			});
		}
