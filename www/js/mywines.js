...
var myWinesView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#mywines',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#mywines',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["previouswinebutton"] = new ClickControl({selector:'#mywines',childSelector:'.previous-container .previous-button',callback:function(e){
			settings.previousWineButtonClicked.notify();
		}});
		_clickControls["selectionItem"] = new ClickControl({selector:'#mywines',childSelector:'.bar-item, .wine-item, .previous-container .previous-item',callback:function(e){
	...
	settings.start = function(){
		...
		_iosScrollView = new IScroll('#mywines .wrapper-scroller',{probeType:3, hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
	};
...
var myWinesListView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#mywines-list',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#mywines-list',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["selectionItem"] = new ClickControl({selector:'#mywines-list',childSelector:'.list-item',callback:function(e){
	...
	settings.populateTemplate = function(templateData){
		...
		_iosScrollView = new IScroll('#mywines-list .wrapper-scroller',{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
...
var myWinesDescView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#mywines-desc',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#mywines-desc',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["iconSelected"] = new ClickControl({selector:'#mywines-desc',childSelector:'.icon-item',callback:function(e){
