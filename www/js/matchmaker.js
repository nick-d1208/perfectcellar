...
var matchMakerCatOneView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#matchmaker-cat-1',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#matchmaker-cat-1',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["selection"] = new ClickControl({selector:'#matchmaker-cat-1',childSelector:'.scroller > .list > .item',callback:function(e){
	...
	settings.populateTemplate = function(templateData){
		...
		_iosScrollView = new IScroll('#matchmaker-cat-1 .wrapper-scroller',{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
	};
...
var matchMakerCatOneController = (function(){
	...
	globalEvent.attach("matchmakercat1:show",function(args){
		_view.populateTemplate(_model.getCategory('foodtype')); // only need to instantiate this once.
...
var matchMakerCatTwoView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#matchmaker-cat-2',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#matchmaker-cat-2',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["selection"] = new ClickControl({selector:'#matchmaker-cat-2',childSelector:'.scroller > .list > .item',callback:function(e){
			$(this).addClass('active');
			settings.selectionClicked.notify({id:$(this).attr('data-id')});
		}});
	};
	...
	settings.populateTemplate = function(templateData){
		...
		_iosScrollView = new IScroll('#matchmaker-cat-2 .wrapper-scroller',{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
	};
...
var matchMakerCatThreeView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#matchmaker-cat-3',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#matchmaker-cat-3',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["selection"] = new ClickControl({selector:'#matchmaker-cat-3',childSelector:'.scroller > .list > .item',callback:function(e){
			$(this).addClass('active');
			settings.selectionClicked.notify({id:$(this).attr('data-id')});
		}});
	};
	...
	settings.populateTemplate = function(templateData){
		...
		_iosScrollView = new IScroll('#matchmaker-cat-3 .wrapper-scroller',{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
	};
...
var matchMakerDescView = (function(){
	...
	if(ClickControl){
		_clickControls["back"] = new ClickControl({selector:'#matchmaker-desc',childSelector:'.mp3-header .icon-left',callback:function(e){
			settings.backButtonClicked.notify();
		}});
		_clickControls["home"] = new ClickControl({selector:'#matchmaker-desc',childSelector:'.mp3-header .icon-right',callback:function(e){
			settings.homeButtonClicked.notify();
		}});
		_clickControls["startagain"] = new ClickControl({selector:'#matchmaker-desc',childSelector:'.breadcrumb > .startagain',callback:function(e){
			settings.startAgainClicked.notify();
		}});
		_clickControls["sharebutton"] = new ClickControl({selector:'#matchmaker-desc',childSelector:'.sharebutton',callback:function(e){
	...
	settings.populateTemplate = function(templateData){
		...
		_iosScrollView = new IScroll('#matchmaker-desc .wrapper-scroller',{hScrollbar:false, vScrollbar:false,hideScrollbar: true, hideScrollbars: true});
	};
